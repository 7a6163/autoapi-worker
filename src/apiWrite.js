...
export async function runWriteAPIs(env) {
  try {
    // Get access token
...
async function uploadToOneDrive(filename, buffer, accessToken) {
...
async function modifyExcelFile(filename, accessToken) {
...
async function createAndDeleteTeam(accessToken) {
...
async function createAndDeleteTask(accessToken) {
...
async function createAndDeleteNotebook(accessToken) {
...
async function apiRequest(method, url, body, accessToken) {
  const headers = {
